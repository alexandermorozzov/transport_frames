...
from transport_frames.transport_frames.constants.constant_osm_tags import service_tags, roads_tags, water_tags, rail_tags
...
def fetch_railways(territory):
    ...
    try:
        railway = ox.features_from_polygon(
            territory, rail_tags).reset_index(drop=True)
