...
def visualize_availability(points: gpd.GeoDataFrame, polygons: gpd.GeoDataFrame, service_gdf: gpd.GeoDataFrame=None,
                            median: bool=True, title='Доступность сервиса, мин') -> None:
    """
